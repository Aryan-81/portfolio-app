        ...
        <div className={style.main}>
            ...
            <div className={style.messageBox}>
                ...
                <div className={style.buttonsCon}>
                    <div className={style.actionLinkWrap}>
                        <a onClick={() => history.back()} className={`${style.linkButton} ${style.linkBackButton}`}>Go Back</a>
                        <a href="/" className={style.linkButton}>Go to Home Page</a>
                    </div>
                </div>
            </div>
